...
#line 119 "HexConverter.xs"
        ...
        char  *err_msg = NULL;
        int    rc;
#line 281 "HexConverter.c"
	SV *	RETVAL;
	SV*	hex_ref = ST(0)
;
#line 126 "HexConverter.xs"
        if (!SvROK(hex_ref)) {
...
#line 112 "HexConverter.xs"
    if (!hex_lookup_initialised) {
        init_hex_lookup_table();
    }

#line 358 "HexConverter.c"
